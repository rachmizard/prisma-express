...
const queryGeneratorJson = (stringifyJson = "") => {
  if (stringifyJson === "") return {};
  if (!isJsonStringValid) throw new Error("Please provide a valid json string");

  return JSON.parse(stringifyJson);
};

module.exports = { queryGenerator, queryGeneratorJson, generateOrderBy };
